...
<body>
    <div class="top-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                   <p><i class="fa fa-map-pin"></i> xxxxxxx
                   </p>
                </div>
                <div class="col-md-6">
                    <ul>
                        <li><a href="" target="_blank"><i class="fa fa-phone"></i> <i class="fa fa-whatsapp"></i> &nbsp; +9199999999999</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="header-nav d-flex justify-content-between align-items-center">
                            <div class="header-logo text-center">
                                <a href="{{ route('user.index') }}"><img src="{{ asset('assets/images/download.png') }}" alt="" class="img-fluid"></a>
                            </div>
                            ...
                            <div class="header-right_wrap d-flex">
                                ...
                                <div class="header-cart">
                                    <a href="#"><i class="fa fa-shopping-bag"></i><span class="cart-count"></span></a>
                                </div>
                                <ul class="ht-us-menu">
                                    @if(Auth::check())
                            ...
                            <div class="row align-items-center">
                                <div class="col-6 col-md-6">
                                    <div class="header-logo">
                                        <a href="index.html">
                                            <img src="{{ asset('assets/img/download.png') }}" class="img-fluid" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-6 col-md-6">
                    ...
                    <div class="off-canvas-contact-widget">
                        <div class="header-contact-info">
                            <ul class="header-contact-info-list">
                                <li><i class="ion-android-phone-portrait"></i> <a href="tel:+919999999999">(+91)
                                    999999999

                                </a></li>
                                <li><i class="ion-android-mail"></i> <a
                                        href="ecommerce@gmail.com">ecommerce@ecomm.com</a></li>
                            </ul>
                        </div>
                    </div>
